...
# Conjunto de comandos para iniciar descarga C2<--S2 con CUBIC
# y para iniciar descarga C1<--S1 con BBR
# Ejemplo de ejecucion desde C1: ./bbr-cub-analysis.sh [short|long]
...
ssh -t S1 "echo it | sudo -S scp /tmp/$FILE_NAME.dat ledbat@C1:/home/ledbat/Documents/100325165/$FILE_NAME-S1.dat"
