...
# Conjunto de comandos para iniciar descarga 
# C1:49001 	<-- 	S1:49101 	con BBR
# C2:49000 	<-- 	S2:80 		con LEDBAT
# C2:49002 	<-- 	S2:49102 	con CUBIC

# Ejemplo de ejecucion desde C1: ./cub-bbr-led-analysis.sh [short|long]
...
ssh -t S2 "echo it | sudo -S scp /tmp/$FILE_NAME.dat ledbat@C1:/home/ledbat/Documents/100325165/$FILE_NAME-S2.dat"
