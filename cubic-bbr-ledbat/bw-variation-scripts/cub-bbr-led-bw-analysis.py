...
csv_file_name13 = FILE_NAME+'-cubic-1mbit-throughput.csv'
csv_file_name14 = FILE_NAME+'-cubic-2mbit-throughput.csv'
csv_file_name15 = FILE_NAME+'-cubic-4mbit-throughput.csv'
csv_file_name16 = FILE_NAME+'-cubic-8mbit-throughput.csv'
csv_file_name17 = FILE_NAME+'-cubic-16mbit-throughput.csv'
csv_file_name18 = FILE_NAME+'-cubic-20mbit-throughput.csv'
...
cubic_mean = []
cubic_mean.append(mean_throughput(CAPTURE_FOLDER,csv_file_name13,binz))
cubic_mean.append(mean_throughput(CAPTURE_FOLDER,csv_file_name14,binz))
cubic_mean.append(mean_throughput(CAPTURE_FOLDER,csv_file_name15,binz))
cubic_mean.append(mean_throughput(CAPTURE_FOLDER,csv_file_name16,binz))
cubic_mean.append(mean_throughput(CAPTURE_FOLDER,csv_file_name17,binz))
cubic_mean.append(mean_throughput(CAPTURE_FOLDER,csv_file_name18,binz))
