...
#./cub-led-bw-analysis.py 2020-08-12_170441-bw-bottle-ledbat
...
csv_file_name1 = FILE_NAME+'-led-1mbit-throughput.csv'
csv_file_name2 = FILE_NAME+'-led-2mbit-throughput.csv'
csv_file_name3 = FILE_NAME+'-led-4mbit-throughput.csv'
csv_file_name4 = FILE_NAME+'-led-8mbit-throughput.csv'
csv_file_name5 = FILE_NAME+'-led-16mbit-throughput.csv'
csv_file_name6 = FILE_NAME+'-led-20mbit-throughput.csv'
csv_file_name7 = FILE_NAME+'-cub-1mbit-throughput.csv'
csv_file_name8 = FILE_NAME+'-cub-2mbit-throughput.csv'
csv_file_name9 = FILE_NAME+'-cub-4mbit-throughput.csv'
csv_file_name10 = FILE_NAME+'-cub-8mbit-throughput.csv'
csv_file_name11 = FILE_NAME+'-cub-16mbit-throughput.csv'
csv_file_name12 = FILE_NAME+'-cub-20mbit-throughput.csv'
...
cubic_mean = []
cubic_mean.append(mean_throughput(CAPTURE_FOLDER,csv_file_name7,binz))
cubic_mean.append(mean_throughput(CAPTURE_FOLDER,csv_file_name8,binz))
cubic_mean.append(mean_throughput(CAPTURE_FOLDER,csv_file_name9,binz))
cubic_mean.append(mean_throughput(CAPTURE_FOLDER,csv_file_name10,binz))
cubic_mean.append(mean_throughput(CAPTURE_FOLDER,csv_file_name11,binz))
cubic_mean.append(mean_throughput(CAPTURE_FOLDER,csv_file_name12,binz))
...
# SIMULAMOS BBR
#rects2 = ax.bar(bw_axis2, cubic_means_ratio, width, label='BBR', color='green')
