...
# y para iniciar descarga C1<--S1 con CUBIC
# Ejemplo de ejecucion desde C1: ./cub-led-analysis.sh [short|long]
...
echo 'Generating CUBIC download C1<--S1 for later analysis...'
LOCAL_CAPTURES='/home/ledbat/Documents/100325165'
FILE_NAME=$(date '+%F_%H%M%S')-cubic-ledbat
