...
data1= np.genfromtxt(CAPTURE_FOLDER+FILE_NAME+'-cubic.csv', delimiter='\t')
...
zwindow1 = [row[9] for row in data1]
...
plt.figure(0)
plt.plot(xtime1,ywindow1,label='CUBIC cwnd',color='blue')
...
plt.figure(1)
plt.plot(xtime1,zwindow1,label='CUBIC rtt',color='blue')
